...
<div class="rounded-2xl border border-white/10 mt-4 ">

    @foreach($paymentProviders as $paymentProvider)
        <div class="border-b border-white/10 p-4">
            <div class="form-control">
                <label class="cursor-pointer text-cream-100 flex justify-between items-center">
                    ...
                    <input type="radio"
                           ...
                           class="radio checked:bg-base-100 checked:text-primary-500 checked:border-primary-500"
